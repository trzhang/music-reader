...
//        	remove(interval);
    ...
    *************************************************************************/
    ...
    public Value search(Interval1D interval) {
        return search(root, interval);
    }

    // look in subtree rooted at x
    public Value search(Node x, Interval1D interval) {
    	while (x != null) {
    ...
    public Iterable<Value> searchAll(Interval1D interval) {
    ...
    // look in subtree rooted at x
    public boolean searchAll(Node x, Interval1D interval, LinkedList<Value> list) {
    ...
    *************************************************************************/
     ...
     *************************************************************************/
     public static void main(String[] args) {
         ...
         IntervalTree<String> st = new IntervalTree<String>();
         for (int i = 0; i < N; i++) { 
         ...
         for (int i = 0; i < N; i++) { 
             ...
             for (String x : st.searchAll(interval))
                 System.out.print(x + " ");
             System.out.println();
             System.out.println();
         }
